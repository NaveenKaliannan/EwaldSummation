...
plot "../data/MadelungConstant_silica.dat" using 1:2  title "" with linespoints ls 1 pt 1 ps 2 
set title "Silica (beta-cristobalite)" font "arial,24"
