...
plot "../data/MadelungConstant_Al2O3.dat" using 1:2  title "" with linespoints ls 1 pt 1 ps 2 
set title "Al2O3 (Corundum)" font "arial,24"
...
set output "../graph/Al2O3_Corundum.png"
replot
